    ...
    <div className="page fade-in">
      ...
      <div className="team-grid" style={{ marginTop: '4rem' }}>
        <article className="team-card">
          ...
          <div className="bio">
            <p>A seasoned veteran with over 15 years of industry experience, Corey is driving the recruiting force behind our white-glove go-to-market recruiting agency. His journey began as a SaaS SDR in San Francisco during the tech boom, but it was the economic collapse of 2008 that defined his career path. Recognizing the natural synergy between high-level sales and talent acquisition, he transitioned into recruiting, mastering the art of the "perfect match" during one of the most challenging markets in history.</p>
